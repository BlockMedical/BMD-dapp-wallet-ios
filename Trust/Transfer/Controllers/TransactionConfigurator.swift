...
final class TransactionConfigurator {
    ...
    init(
        ...
        let calculatedGasPrice = min(max(transaction.gasPrice ?? chainState.gasPrice ?? GasPriceConfiguration.blockMedDefault, GasPriceConfiguration.min), GasPriceConfiguration.max)
